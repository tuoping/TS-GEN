...
from ..utils.globals import MODELS_PROJECT_ROOT, get_device, get_pyg_device
from ..utils.lattice_score import edge_score_to_lattice_score_frac_symmetric
...
class GemNetT(torch.nn.Module):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        super().__init__()
        scale_file = f"{MODELS_PROJECT_ROOT}/model/gemnet/gemnet-dT.json"
    ...
    def generate_interaction_graph(
        ...
        return (
            ...
            neighbors.to(torch_device),
            D_st.to(torch_device),
            V_st.to(torch_device),
            id_swap.to(torch_device),
            id3_ba,
            id3_ca,
            id3_ragged_idx,
            cell_offsets.to(torch_device),
        )
